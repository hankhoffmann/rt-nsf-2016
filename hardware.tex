...
\begin{figure}[t]
\vskip -1.8em
\subfloat[Energy/Latency Tradeoffs]{\input{img/tradeoffs.tex}
...
\item The heterogeneous processor can reach speeds of up to $1.33
  \times$ faster than it can safely sustain.
\end{itemize}
